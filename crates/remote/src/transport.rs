...
use util::{command::Child, shell::ShellKind};
...
pub(super) fn remote_server_cli_setup_script(shell_kind: ShellKind) -> Option<&'static str> {
    match shell_kind {
        ShellKind::Fish => Some(concat!(

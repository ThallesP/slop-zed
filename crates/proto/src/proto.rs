...
messages!(
    ...
    (CreateTerminalSession, Background),
    (CreateTerminalSessionResponse, Background),
    ...
    (ListTerminalSessions, Background),
    (ListTerminalSessionsResponse, Background),
    ...
    (Test, Foreground),
    (AttachTerminalSession, Background),
    (TerminalInput, Background),
    (TerminalOutput, Background),
    (ResizeTerminalSession, Background),
    (CloseTerminalSession, Background),
    (TerminalSessionExited, Background),
    (Toast, Background),
    (Unfollow, Foreground),
...
request_messages!(
    ...
    (CreateTerminalSession, CreateTerminalSessionResponse),
    (DeclineCall, Ack),
    (DeleteChannel, Ack),
    ...
    (AttachTerminalSession, Ack),
    (TerminalInput, Ack),
    (ResizeTerminalSession, Ack),
    (CloseTerminalSession, Ack),
    (ListTerminalSessions, ListTerminalSessionsResponse),
